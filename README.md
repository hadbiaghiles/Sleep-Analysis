...
The interactive dashboard lives in `docs/index.html` (generated by `python generate_site.py`). A GitHub Action (`.github/workflows/pages.yml`) publishes that folder.

Regenerate the static site after dataset changes:
